...
import s from "./bestsell.module.css"
...
export default function Bestsell({ handleModalSubmit, addItem }) {
    ...
    useEffect(() => {
        const filteredNewData = Carddata.filter(item => item.meilleurvente === 'oui');
        setMeilleurVente(filteredNewData);
    }, []);
